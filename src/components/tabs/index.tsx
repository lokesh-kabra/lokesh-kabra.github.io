...
export function TabsDemo() {
  ...
  const webApp = `Web App Development:
  In the digital landscape, I specialize in developing web applications that are not only visually appealing but also highly functional and user-friendly. Leveraging the latest technologies and best practices, I create web apps that cater to the unique needs of businesses and users alike. From e-commerce platforms to content management systems, my expertise in web app development ensures that every project is delivered with precision and excellence.
  
  IoT & AI Development: I specialize in IoT & AI development, creating interconnected systems that collect, analyze, and act on data in real-time. From smart home devices to industrial IoT solutions, my expertise in IoT development helps businesses harness the power of connected technology to drive innovation and enhance the user experience.`
